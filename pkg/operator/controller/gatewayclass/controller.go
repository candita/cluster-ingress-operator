...
func NewUnmanaged(mgr manager.Manager, config Config) (controller.Controller, error) {
	...
	isOurGatewayClass := predicate.NewPredicateFuncs(func(o client.Object) bool {
		class := o.(*gatewayapi.GatewayClass)
	...
	if err := c.Watch(source.Kind[client.Object](operatorCache, &gatewayapi.GatewayClass{}, &handler.EnqueueRequestForObject{}, isOurGatewayClass, notIstioGatewayClass)); err != nil {
		return nil, err
	}
	return c, nil
}
